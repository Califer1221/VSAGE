...
for j = 1:size_x(2)
    for i=1:size_CCO_size(2)
        ...
        %disp(CCO_size(i));
        [freq(j, i, k), kcco(j, i, k),diff_kcco(j, i, k), Res(j,i, k), Rcco(j,i, k), Vctrl(j,i, k)]=f_spline_CCO_DCAP_all_size_v1(x(j),N,i,k);
        end
    end
end
...
ylabel({'MHz'},'Fontname', 'Times New Roman','FontSize',16)
...
title('kcco vs. Ictrl ')
xlabel({'Ictrl/uA'},'Fontname', 'Times New Roman','FontSize',16)
ylabel({'MHz/uA'},'Fontname', 'Times New Roman','FontSize',16)
set(gca,'Fontname', 'Times New Roman','FontSize',10);
legend([p(1,1),p(2,1),p(3,1),p(4,1),p(5,1)],CCO_size_lib);
...
xlabel({'Ictrl/uA'},'Fontname', 'Times New Roman','FontSize',16)
ylabel({'MHz/uA^2'},'Fontname', 'Times New Roman','FontSize',16)
set(gca,'Fontname', 'Times New Roman','FontSize',10);
legend([p(1,1),p(2,1),p(3,1),p(4,1),p(5,1)],CCO_size_lib);
...
title('Res vs. Ictrl')
xlabel({'Ictrl/uA'},'Fontname', 'Times New Roman','FontSize',16)
ylabel({'kOhm'},'Fontname', 'Times New Roman','FontSize',16)
set(gca,'Fontname', 'Times New Roman','FontSize',10);
legend([p(1,1),p(2,1),p(3,1),p(4,1),p(5,1)],CCO_size_lib);
...
xlabel({'Ictrl/uA'},'Fontname', 'Times New Roman','FontSize',16)
ylabel({'Vctrl/mV'},'Fontname', 'Times New Roman','FontSize',16)
set(gca,'Fontname', 'Times New Roman','FontSize',10);
legend([p(1,1),p(2,1),p(3,1),p(4,1),p(5,1)],CCO_size_lib);
