...
fprintf(fileID, 'selectObject Module I13 \n');
fprintf(fileID, 'createInstGroup PD13 -fence %.4f %.4f %.4f %.4f \n', loc_SW);
fprintf(fileID, 'setInstGroupPhyHier PD13 \n');
fprintf(fileID, 'addInstToInstGroup PD13 {I13 } \n');
fprintf(fileID, 'deselectModule I13 \n');
fprintf(fileID, '\n');
...
VDD9 = [loc_SW(1:2)-2, loc_SW(3:4)+2];
