...
fprintf(fileID, '\n');
fprintf(fileID, '\n');
fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VCTRLP1(1), VCTRLP1(2), VCTRLP1(3), VCTRLP1(4));
fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VCTRLN1(1), VCTRLN1(2), VCTRLN1(3), VCTRLN1(4));
fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VCTRLP2(1), VCTRLP2(2), VCTRLP2(3), VCTRLP2(4));
fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VCTRLN2(1), VCTRLN2(2), VCTRLN2(3), VCTRLN2(4));

fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VDD4(1), VDD4(2), VDD4(3), VDD4(4));
fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VDD7(1), VDD7(2), VDD7(3), VDD7(4));
fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VDD8(1), VDD8(2), VDD8(3), VDD8(4));

fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VREFP9(1), VREFP9(2), VREFP9(3), VREFP9(4));
fprintf(fileID, 'addWellTap -cell TAPCELLBWP12T30P140 -cellInterval {%.4f} -prefix WELLTAP -area { %.4f %.4f %.4f %.4f } \n', interval, VREFP10(1), VREFP10(2), VREFP10(3), VREFP10(4));
...
system('cat start_loading_2nd_order.txt  floorplan_2nd.txt  power_ring_2nd_order.txt  Follow_pin_2nd.txt Well_Tap.txt Placement.txt Filler.txt Routing.txt > Start2end_2nd.tcl')
