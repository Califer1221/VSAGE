...
area_PFD=(1.6*2+2.8*2+1.2+ 0.42+ 0.7*2 + 1.26*2) * 2 * H * N_PFD/2;
area_PFD_act=area_PFD/factor;

%Switch
% 4*2.4    +  22.8*2
% INVD8        switches
area_SW=(4*1.26    +  11.44*2)*H*N_PFD;
...
% DAC1&2  W/L=3/1 % 2.5/1
W_DAC = round((area_DAC_act1*2.5)^0.5);
